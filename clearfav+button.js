(function () {
    ...
    function clearOnlyHistory() {
        clearHistory();
        notify('История просмотров очищена');
    }

    function clearOnlyFavorite() {
        clearFavorite();
    ...
    function createSettings() {
        ...
        Lampa.SettingsApi.addParam({
            component: pluginId,
            param: {
                name: pluginId + '_clear_history',
                type: 'button',
                default: false
            },
            field: {
                name: 'Очистка истории просмотров'
            },
            onChange: clearOnlyHistory
        });

        Lampa.SettingsApi.addParam({
            component: pluginId,
            param: {
                name: pluginId + '_clear_favorite',
                type: 'button',
                default: false
            },
            field: {
                name: 'Очистка вкладки Избранное'
            },
            onChange: clearOnlyFavorite
        });
